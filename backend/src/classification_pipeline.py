...
from src.visualisation.visualisation import plot_classification_metrics, plot_confusion_matrix, \
    plot_correlation_with_target, plot_distribution_categorical_features, plot_correlation_matrix
...
#plot_distribution_categorical_features(df_employee_attrition, CATEGORICAL_FEATURES_ONE_HOT)
...
sample_predictions = loaded_model.predict(x_test[:20])
